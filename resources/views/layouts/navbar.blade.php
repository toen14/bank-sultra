...
@php
    $user = auth()->user();
    $notifications = \App\Models\Notification::with(['note', 'note.user'])
            ...
            <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                ...
                <li class="nav-item dropdown hidden-caret">
                    <a class="nav-link dropdown-toggle nav-icon" href="#" id="notifDropdown" role="button"
                        ...
                        <span class="notification font-weight-bold">{{ $notifications->count() }}</span>
                    </a>
                        ...
                        <li>
                            <div class="notif-center">
                                @foreach ($notifications as $notification)
                                    <a href="#">
                                        <span
                                            class="avatar-sm rounded-circle d-flex justify-content-center align-items-center text-primary font-weight-bold m-2"
                                            style="background-color: rgb(202, 202, 202);">
                                            {{ iconName($notification->note->user->name) }}
                                        </span>
                                        <div class="notif-content">
                                            <span class="block">
                                                {{ $notification->note->user->name }} membuat note
                                            </span>
